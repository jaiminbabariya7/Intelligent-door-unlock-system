...
def train_user():
    ...
    path = 'E:/Study_Material/All ML projects/face-voice-recognition-master/dataset/'+face_id
    os.mkdir(path)
    ...
    while (True):
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.imwrite("E:/Study_Material/All ML projects/face-voice-recognition-master/dataset/"+face_id+"/User." + str(face_id) + '.' + str(count) + ".jpg", gray[y:y + h, x:x + w])
    ...
    train_path = 'E:/Study_Material/All ML projects/face-voice-recognition-master/trainer/'+face_id
    os.mkdir(train_path)
    # Save the model into trainer/trainer.yml
    recognizer.write('E:/Study_Material/All ML projects/face-voice-recognition-master/trainer/'+face_id+'/trainer.yml')  # recognizer.save() worked on Mac, but not on Pi
    ...
    waveFile = wave.open(WAVE_OUTPUT_FILENAME + '/' + name + '_sound_' + face_id + '.wav', 'wb')
